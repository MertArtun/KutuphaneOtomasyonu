        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Kitap Ekleme Alanı</h1>
                    <div class="row">
                    ...
                    <input type="text" name="bagiskitap" placeholder="Bağış Yapılan Kitap Adı"><br><br>
                            ...
                            <!-- Bar Chart -->
                                         ...
                                         <input type="submit" name="eklebagis" value="Ekle" class="btn btn-primary btn-user btn-block">
                                          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th> İd</th>
                                            <th>Bağış Yapan Adı</th>        
                                            <th>Bağış Yapan E-Posta</th>
                                            <th>Bağış Yapılan Kitap</th>          
                                        </tr>
                                    </thead>
                                    <tbody>
                ...
                if ($bagissorgusql) {
                    while ($bagissatiri = $bagissorgusql->fetch_assoc()) {
                        echo  
                        "<tr>".
                        "<td>".$bagissatiri["id"]."</td>".   
                        "<td>".$bagissatiri["bagisyapanadi"]."</td>".
                        "<td>".$bagissatiri["bagisyapaneposta"]."</td>".
                        "<td>".$bagissatiri["bagiskitapadi"]."</td>"
                        ."</tr>";
