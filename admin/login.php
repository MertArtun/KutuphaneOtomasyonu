                                    ...
                                    <form class="login" action="logincontrol.php" method="post">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                ...
                                                placeholder="E-Posta" name="user">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Şifre" name="pass">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <input type="submit" class="btn btn-primary btn-user btn-block" Value="Giriş Yap" name="girisyap">
